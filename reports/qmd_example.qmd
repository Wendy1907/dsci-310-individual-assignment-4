...
#| fig-cap: "Horse populations for all provinces in Canada from 1907 - 1972."
#| out-width: 70%
...
Suppose we were interested in looking in more closely at the province with the highest spread (in terms of standard deviation) of horse populations. We present the standard deviations in @tbl-horses-spread.

```{r}
#| echo: false
#| message: false
#| label: tbl-horses-spread
...
Additionally, note that in @tbl-horses-spread we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-pops.
